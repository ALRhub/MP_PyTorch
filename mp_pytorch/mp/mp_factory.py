...
from mp_pytorch.basis_gn import NormalizedRBFBasisGenerator, ZeroStartNormalizedRBFBasisGenerator
...
class MPFactory:
    ...
    def init_mp(config):
        ...
        elif mp_type == 'zero_start_promp':
            phase_gn = LinearPhaseGenerator(tau=tau,
                                            learn_tau=learn_tau,
                                            learn_delay=learn_delay)
            basis_gn = ZeroStartNormalizedRBFBasisGenerator(
                phase_generator=phase_gn,
                num_basis=mp_config["num_basis"],
